...
function courseFieldStatus()
{
 var oprtn = document.getElementById('operation').value;
 if ( oprtn == "#" ) 
 {
 	document.getElementById('num_courses').type = "hidden";
 ...
 else 
 {
  if ( oprtn == "CGPA" ) 
  {
 	document.getElementById('num_courses').type = "NUMBER";
...
function operationInfoBtn() 
{
 ...
 if ( num_course.match('[a-zA-Z]') || num_course.length <= 0 || num_course < 1 ) 
 {
