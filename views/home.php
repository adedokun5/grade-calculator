...
<main class="container py-5">
 <div class="row my-5 m-1">
  <section class="col-md-5 shadow fw-bold text-muted rounded ms-md-5 ">
    <div class="row p-2">
      <h2 class="text-success text-center text-decoration-underline"><strong>About</strong></h2>
      <p>
       <strong>Grade Point APP </strong>is built to enable student calculate their :
      </p>
      <ul class="list">
       <li class="list-item">Cummulative Grade Point Average ( CGPA ).</li>
       <li class="list-item">Semesterial Grade Point Average ( SGPA ).</li>  
      </ul>
      <p>
       Using either the
      </p>
      <ul class="list">
       <li class="list-item">Five Point Grading System or</li>
       <li class="list-item">Four Point Grading System.</li>  
      </ul>        
    </div>
  </section>
  <section class="col-md-5 border ms-md-5 p-2 mt-3 mt-md-0 fw-bold bg-light rounded">
    ...
    <ol class="list">
     ...
     <li class="list-item">Enter Number Of Course Offered.</li>
    ...
    <div class="d-flex justify-content-center">
     <button class="btn btn-success"><a href="user_info" class="h4 text-white">Get Started</a></button>
    </div>
  </section>
 </div>
</main>
